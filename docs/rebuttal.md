...
<details>
<summary>Then answer the questions raised in the justification and weaknesses</summary>
...
<details>
<summary>After finishing the first draft of the rebuttal, mark each reviewer's main questions (usually given in the justification), then check repeatedly whether you have answered the reviewer's questions correctly and whether they would convince the reviewer. Also ask a fellow student to look at it and check whether you have addressed the reviewer's main questions sensibly.</summary>
