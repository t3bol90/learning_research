...
![Paper writing planning, page 3](./assets/template/003.png)

![Paper writing planning, page 4](./assets/template/004.png)
...
![Polishing a paper iteratively](./assets/template/005.png)
...
![Neural Body example diagram](./assets/template/006.png)
...
![Instant NGP example](./assets/template/007.png)
...
![Neural Body Section 3.1 example](./assets/template/008.png)
...
![Good-looking table example 1](./assets/template/009.png)

![Good-looking table example 2](./assets/template/010.png)

Iterate step by step:

1. Put the caption above the table

    ![Caption above table example](./assets/template/011.png)
...
2. Avoid vertical lines, and do not connect vertical and horizontal lines: change `\hline` in LaTeX to `\toprule`, `\midrule`, `\bottomrule`
    ...
    ![Table without vertical lines example](./assets/template/012.png)

3. Use horizontal lines sparingly; too many disrupt the eye

    ![Table with fewer horizontal lines](./assets/template/013.png)

4. Colour the highlighted numbers

    ![Table with highlighted numbers in colour](./assets/template/014.png)
